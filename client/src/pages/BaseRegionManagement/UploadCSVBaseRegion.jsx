...
const UploadCSVBaseRegion = () => {
    ...
    const handleFileUpload = async () => {
        ...
        try {
            ...
            let response = await fetch('/api/region/csv_upload', {
                method: 'POST',
                headers: {
            ...
            if (!response.ok) {
                ...
                if (response.status === 401) {
                    try {
                        ...
                        response = await fetch('/api/region/csv_upload', {
                            method: 'POST',
                            headers: {
                                'Authorization': `Bearer ${accessToken}`
                            },
    ...
    return (
        <Box sx={{ p:2, justifyContent: "center", alignItems: 'center', height: '70vh' }}>
            ...
            <Typography variant="h4">
                Upload CSV File for Base Region Data
            </Typography>
...
export default UploadCSVBaseRegion;